...
RES=$B/ariane_detour_arc_results.txt
...
run_arm ardet_base
run_arm ardet_arc002 --detour_timing_weight 0.02 --detour_arc True
run_arm ardet_arc010 --detour_timing_weight 0.10 --detour_arc True
