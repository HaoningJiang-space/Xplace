# bp_be_top back-end on an Xplace placement DEF (macros fixed). GR-based.
set NG /data/ziheng/wzh/orfs/OpenROAD-flow-scripts/flow/platforms/nangate45
set DES /data/ziheng/wzh/orfs/OpenROAD-flow-scripts/flow/designs/nangate45/bp_be_top
set OUT $::env(XP_OUT)
file mkdir $OUT
set_thread_count 16
