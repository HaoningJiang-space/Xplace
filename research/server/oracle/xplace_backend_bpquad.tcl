# bp_quad (bsg_chip) back-end on an Xplace placement DEF (macros fixed). GR-based.
set NG /data/ziheng/wzh/orfs/OpenROAD-flow-scripts/flow/platforms/nangate45
set DES /data/ziheng/wzh/orfs/OpenROAD-flow-scripts/flow/designs/nangate45/bp_quad
set OUT $::env(XP_OUT)
file mkdir $OUT
set_thread_count 16
read_lef $NG/lef/NangateOpenCellLibrary.tech.lef
read_lef $NG/lef/NangateOpenCellLibrary.macro.mod.lef
read_lef $NG/lef/fakeram45_256x48.lef
read_lef $NG/lef/fakeram45_32x32.lef
read_lef $NG/lef/fakeram45_64x124.lef
read_lef $NG/lef/fakeram45_512x64.lef
read_lef $NG/lef/fakeram45_64x62.lef
read_lef $NG/lef/fakeram45_128x116.lef
read_liberty $NG/lib/NangateOpenCellLibrary_typical.lib
read_liberty $NG/lib/fakeram45_256x48.lib
read_liberty $NG/lib/fakeram45_32x32.lib
read_liberty $NG/lib/fakeram45_64x124.lib
read_liberty $NG/lib/fakeram45_512x64.lib
read_liberty $NG/lib/fakeram45_64x62.lib
read_liberty $NG/lib/fakeram45_128x116.lib
read_def $::env(XP_DEF)
source $DES/bsg_chip.sdc
source $NG/setRC.tcl
